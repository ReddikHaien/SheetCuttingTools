...
public class FSIntersectionConstraintComponent() : BaseFlattenedSegmentConstraint("Flattened Segment Intersection Constraint", "FSIC", "Prevents flattened segments from self intersecting")
{
